...
export default function Sidebar() {
  ...
  <>
      {/* Sidebar */}
      <div className={` fixed w-screen  bottom-0 bg-white p-2 ${location.pathname === "/msgs" ? "hidden" : ""} md:block  md:top-0 md:left-0 md:h-full z-50   md:p-4 lg:w-64 md:w-fit  border-r-2 border-gray-200`}>
        ...
        <nav className="w-fit flex  justify-center md:flex-col gap-5 md:gap-2">
          {navItems.map((item) => {
